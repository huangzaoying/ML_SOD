...
class setting_config:
    ...
    if opt == "Adadelta":
        ...
        etas = (
            0.5,
            1.2,
        )  # default: (0.5, 1.2) – pair of (etaminus, etaplis), that are multiplicative increase and decrease factors
        step_sizes = (
            1e-6,
            50,
        )  # default: (1e-6, 50) – a pair of minimal and maximal allowed step sizes
    elif opt == "SGD":
